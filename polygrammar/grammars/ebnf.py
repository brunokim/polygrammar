...
DQUOTE_STRING_ESCAPE = CombinedEscapes(
    [DUPLICATE_DOUBLE_QUOTE_ESCAPE, PYTHON_SINGLE_CHAR_ESCAPE, UNICODE_BACKSLASH_ESCAPE]
)
SQUOTE_STRING_ESCAPE = CombinedEscapes(
    [DUPLICATE_SINGLE_QUOTE_ESCAPE, PYTHON_SINGLE_CHAR_ESCAPE, UNICODE_BACKSLASH_ESCAPE]
)
